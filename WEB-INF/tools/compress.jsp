...
<head>
    ...
    <title>GIF压缩工具_GIF制作工具_GIF裁剪工具_视频转GIF工具_SOOGIF</title>
	...
	<meta name="keywords" content="GIF动图压缩工具,GIF动图制作工具,GIF动图水印工具,GIF动图裁剪工具,视频转GIF工具" />
...
<body class="back">
	...
	<div class="nav-wrap">
	    <div class="toolNav">
			<a href="/compress" class="toolCompress active"><i></i>GIF压缩</a>
			<a href="/crop" class="toolCut"><i></i>GIF裁剪</a>
			<a href="/editor" class="toolBeauty"><i></i>GIF编辑</a>
    ...
    <!-- iframe调用的页面 --> 
    <!--<iframe src="http://106.75.77.69/html/tool/CompressMain.html" frameborder="0" width="100%" height="680" id="iframeId" scrolling="no"></iframe>-->
    <iframe src="${basePath}/html/tool/CompressMain.html" frameborder="0" width="100%" height="680" id="iframeId" scrolling="no"></iframe>
    <!--<iframe src="http://114.215.17.203/html/tool/CompressMain.html" frameborder="0" width="100%" height="680" id="iframeId" scrolling="no"></iframe>--> 
    
    <!-- js引用 -->
	<script src="${basePath}/js/compress.js"></script>
	...
	<script type="text/javascript">
		...
		function handleReceive(event){
			if(event.origin == "http://106.75.77.69"){
//			if(event.origin == "http://114.215.17.203"){
//			if(event.origin == "http://localhost:8080"){
				//处理数据
		  		...
		  		if(data.indexOf("height:")!=-1){
					...
					ifr_el.style.height = _height+"px";
				}
			}
		}
