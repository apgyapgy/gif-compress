...
<head>
    ...
    <title>GIF裁剪工具_GIF压缩工具_GIF制作工具_视频转GIF工具_SOOGIF</title>
	...
	<meta name="keywords" content="GIF动图裁剪工具,GIF动图压缩工具,GIF动图制作工具,GIF动图水印工具,视频转GIF工具" />
...
<body class="back">
	...
	<div class="nav-wrap">
	    <div class="toolNav">
			...
			<a href="/crop" class="toolCut active"><i></i>GIF裁剪</a>
	...
	<!--导航 结束-->
    <!-- iframe调用的页面 -->
    <iframe src="http://106.75.12.84/gifCrop/index.html" frameborder="0" width="100%" height="680" id="iframeId" scrolling="yes"></iframe>
	<script type="text/javascript">
		var _url = window.location.search;
		if(_url){
			if(_url.indexOf("?url=") != -1){
				document.getElementById("iframeId").src = "http://106.75.12.84/gifCrop/index.html"+_url;
			}
		}
	</script>
    <!-- js引用 -->
	...
	<script type="text/javascript">
		...
		function handleReceive(event){  
			if(event.origin == "http://106.75.12.84"){
				//处理数据
